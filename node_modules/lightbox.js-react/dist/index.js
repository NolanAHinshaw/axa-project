...
var SlideshowLightbox = React.forwardRef(function (props, ref) {
  ...
  var _useState33 = React.useState(props.metadataTimeLocale ? props.metadataTimeLocale : "en-US"),
    metadataLocale = _useState33[0];
  var _useState34 = React.useState(props.rtl ? props.rtl : false),
    isRTL = _useState34[0];
  var _useState35 = React.useState(props.framework ? props.framework : ''),
    frameworkID = _useState35[0];
  var _useState36 = React.useState(props.lightboxIdentifier ? props.lightboxIdentifier : false),
    lightboxIdentifier = _useState36[0];
  var _useState37 = React.useState(props.fullScreen ? props.fullScreen : false),
    imageFullScreen = _useState37[0];
  var _useState38 = React.useState(props.licenseKey ? props.licenseKey : '');
  var _useState39 = React.useState(props.showLoader ? props.showLoader : false),
    displayLoader = _useState39[0],
    setDisplayLoader = _useState39[1];
  var _useState40 = React.useState(props.startingSlideIndex ? props.startingSlideIndex : 0),
    setStartingIndex = _useState40[1];
  var _useState41 = React.useState(props.backgroundColor ? props.backgroundColor : themes[defaultTheme].background),
    backgroundColor = _useState41[0],
    setBackgroundColor = _useState41[1];
  var _useState42 = React.useState(props.iconColor ? props.iconColor : null),
    iconColor = _useState42[0],
    setIconColor = _useState42[1];
  var _useState43 = React.useState(props.textColor ? props.textColor : themes[defaultTheme].textColor),
    textColor = _useState43[0],
    setTextColor = _useState43[1];
  var _useState44 = React.useState(props.useCoverMode ? props.useCoverMode : false),
    coverMode = _useState44[0];
  var _useState45 = React.useState(props.displayMetadata ? props.displayMetadata : false),
    displayImgMetadata = _useState45[0];
  var _useState46 = React.useState(false),
    showImgMetadataPanel = _useState46[0],
    setShowImgMetadataPanel = _useState46[1];
  var _useState47 = React.useState({}),
    imgMetadata = _useState47[0],
    setImgMetadata = _useState47[1];
  ...
  var _useState52 = React.useState(false),
    setYTVideoCurrentlyPlaying = _useState52[1];
  var _useState53 = React.useState(false),
    isBrowserFullScreen = _useState53[0],
    setIsBrowserFullScreen = _useState53[1];
  var _useState54 = React.useState(false),
    enableMagnifyingGlass = _useState54[0],
    setMagnifyingGlass = _useState54[1];
  var _useState55 = React.useState(false),
    imagesLoaded = _useState55[0],
    setImagesLoaded = _useState55[1];
  var imageRef = React.useRef(null);
  var _useState56 = React.useState(0),
    zoomIdx = _useState56[0],
    setZoomIdx = _useState56[1];
  var _useState57 = React.useState(500),
    imgContainHeight = _useState57[0],
    setImgContainHeight = _useState57[1];
  var _useState58 = React.useState(426),
    imgContainWidth = _useState58[0],
    setImgContainWidth = _useState58[1];
  var _useState59 = React.useState(false),
    isInit = _useState59[0],
    setIsInit = _useState59[1];
  var open = props.open;
  ...
  var _useState60 = React.useState({}),
    videoElements = _useState60[0],
    setVideoElements = _useState60[1];
  var _useState61 = React.useState(true),
    isLoading = _useState61[0],
    setIsLoading = _useState61[1];
  ...
  var _useState62 = React.useState(props.thumbnailBorder ? createCustomThumbnailBorder() : themes[defaultTheme].thumbnailBorder),
    thumbnailBorder = _useState62[0];
