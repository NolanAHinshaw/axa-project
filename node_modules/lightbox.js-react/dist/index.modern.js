...
var SlideshowLightbox = forwardRef(function (props, ref) {
  ...
  var _useState33 = useState(props.metadataTimeLocale ? props.metadataTimeLocale : "en-US"),
    metadataLocale = _useState33[0];
  var _useState34 = useState(props.rtl ? props.rtl : false),
    isRTL = _useState34[0];
  var _useState35 = useState(props.framework ? props.framework : ''),
    frameworkID = _useState35[0];
  var _useState36 = useState(props.lightboxIdentifier ? props.lightboxIdentifier : false),
    lightboxIdentifier = _useState36[0];
  var _useState37 = useState(props.fullScreen ? props.fullScreen : false),
    imageFullScreen = _useState37[0];
  var _useState38 = useState(props.licenseKey ? props.licenseKey : '');
  var _useState39 = useState(props.showLoader ? props.showLoader : false),
    displayLoader = _useState39[0],
    setDisplayLoader = _useState39[1];
  var _useState40 = useState(props.startingSlideIndex ? props.startingSlideIndex : 0),
    setStartingIndex = _useState40[1];
  var _useState41 = useState(props.backgroundColor ? props.backgroundColor : themes[defaultTheme].background),
    backgroundColor = _useState41[0],
    setBackgroundColor = _useState41[1];
  var _useState42 = useState(props.iconColor ? props.iconColor : null),
    iconColor = _useState42[0],
    setIconColor = _useState42[1];
  var _useState43 = useState(props.textColor ? props.textColor : themes[defaultTheme].textColor),
    textColor = _useState43[0],
    setTextColor = _useState43[1];
  var _useState44 = useState(props.useCoverMode ? props.useCoverMode : false),
    coverMode = _useState44[0];
  var _useState45 = useState(props.displayMetadata ? props.displayMetadata : false),
  ...
  var _useState62 = useState(props.thumbnailBorder ? createCustomThumbnailBorder() : themes[defaultTheme].thumbnailBorder),
